  ...
  return (
    ...
    <div className='formcenter'>
        ...
        <h1 className="h">Enter your Email</h1>
            <label className='formname'><h4>Email</h4></label>
            <input type='text'  className="forminput" placeholder='Email' onChange={(e)=>{setEmail(e.target.value)}} ></input>
            {errors.email && <span className="error">{errors.email}</span>}
        <   button type='submit' className='formbuttton'>Next</button>
        </form>
    </div>
    </>
  )
